...
public struct Properties
{
    ...
    internal Properties ConvertToPx(Vector2D<float> parentSize)
    {
        borderRadiusTopLeft.ConvertToPx(parentSize);
        borderRadiusTopRight.ConvertToPx(parentSize);
        borderRadiusBottomRight.ConvertToPx(parentSize);
        borderRadiusBottomLeft.ConvertToPx(parentSize);
