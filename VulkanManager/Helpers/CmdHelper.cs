...
{
    public static unsafe CommandBuffer BeginSingleTimeCommands(CommandPool commandPool)
    {
    ...
    public static unsafe void EndSingleTimeCommandsIdle(CommandPool commandPool, CommandBuffer commandBuffer)
    {
